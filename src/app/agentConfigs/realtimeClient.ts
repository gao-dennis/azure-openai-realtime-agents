...
export class RealtimeClient {
  ...
  async connect() {
    ...
    await this.#session.connect({ apiKey: ek, model: "gpt-4o-mini-realtime-preview", url: "https://eastus2.realtimeapi-preview.ai.azure.com/v1/realtimertc" });
